...
"""Verify that starting bitcupd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcupd with -h for help text")
        ...
        self.log.info("Start bitcupd with -version for version information")
        ...
        self.log.info("Start bitcupdd with -fakearg to make sure it does not start")
