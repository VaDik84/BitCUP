...
This mechanism has been integrated into Bitcore-Node-BitCUP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcuppay/insight-api-bitcup#web-socket-api](https://github.com/bitcuppay/insight-api-bitcup#web-socket-api)
* API: [https://github.com/bitcuppay/insight-api-bitcup#instantsend-transactions](https://github.com/bitcuppay/insight-api-bitcup#instantsend-transactions)
