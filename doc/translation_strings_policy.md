...
This document provides guidelines for internationalization of the BitCUP Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcup_en.ts` remains unchanged.
