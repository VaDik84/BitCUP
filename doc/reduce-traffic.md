...
By default, BitCUP Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that bitcup's trustless model works best if you are
