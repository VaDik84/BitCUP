...
At the first startup BitCUP Core will run a migration process which can take
...
incompatible with older versions of BitCUP Core, so a db migration path was
...
See detailed [set of changes](https://github.com/VaDik84/compare/v19.1.0...bitcuppay:v19.2.0).
