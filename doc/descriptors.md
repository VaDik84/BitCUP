# Support for Output Descriptors in BitCUP Core

Since BitCUP Core v0.17, there is support for Output Descriptors. This is a
...
existing BitCUP Core wallets, a convenience function `combo` is
...
All RPCs in BitCUP Core will include the checksum in their output. Only
