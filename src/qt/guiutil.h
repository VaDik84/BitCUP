...
/** Utility functions used by the BitCUP Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcup:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load bitcup specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a bitcup specific theme is activated (light/dark).*/
