 ...
 *  We have 4 times smaller block times in BitCUP, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        BitCUP Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // BCP this code also handles non-TXs (BitCUP specific messages)
