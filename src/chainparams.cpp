 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1737647481, nBits=1e0ffff0, nNonce=2040755, vtx=1)
...
{
    const char* pszTimestamp = "The quick brown fox jumps over the lazy dog";
    const CScript genesisOutputScript = CScript() << ParseHex("044ab275c8bdaf56e125f97c541850f66a1276fab9aa910629c17b2b705b6a916a72902837d942458fe61c8e7832a553dc751bbbf675a687832d8e1beb47d94608") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsCycleBlocks = 6257.1428571429;
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 1; 
        consensus.nSuperblockStartHash = uint256();
        consensus.nSuperblockCycle = 6257.1428571429;
        ...
        consensus.nPowTargetTimespan = 14 * 60;
        ...
        consensus.defaultAssumeValid = uint256S("0x0000003385d11086ca08060a04a067962919086e37bbbd74d2fd8e7b14ed7e06"); 
        ...
        genesis = CreateGenesisBlock(1737647481, 2040755, 0x1e0ffff0, 1, 75 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000003385d11086ca08060a04a067962919086e37bbbd74d2fd8e7b14ed7e06"));
        assert(genesis.hashMerkleRoot == uint256S("0xe2a6a40237e19e792dbdd804e358f5efcde6482b9a24eb9bca738426812f6f0e"));
        ...
        // BitCUP BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // BitCUP BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // BitCUP BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"BRNE8QVk2rEp3oCZkZ1EEqFydvHpWRXzYx"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000003385d11086ca08060a04a067962919086e37bbbd74d2fd8e7b14ed7e06")},
            }
        };
        ...
        // getchaintxstats 17280 0000003385d11086ca08060a04a067962919086e37bbbd74d2fd8e7b14ed7e06
        chainTxData = ChainTxData{
                1737647481, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000131688ce83e41ae075bcb0e60273f2a2a3549be78edc206e7ff725c6344"); 
        ...
        genesis = CreateGenesisBlock(1737647486UL, 910355UL, 0x1e0ffff0, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000131688ce83e41ae075bcb0e60273f2a2a3549be78edc206e7ff725c6344"));
        assert(genesis.hashMerkleRoot == uint256S("0xe2a6a40237e19e792dbdd804e358f5efcde6482b9a24eb9bca738426812f6f0e"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,153);
        // Testnet BitCUP BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet BitCUP BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet BitCUP BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"BL1sNBVqWw7ZN9p4eC4qjrB6TLRuYjo4KW"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000131688ce83e41ae075bcb0e60273f2a2a3549be78edc206e7ff725c6344")},
            }
        };
        ...
        // getchaintxstats 17280 00000131688ce83e41ae075bcb0e60273f2a2a3549be78edc206e7ff725c6344
        chainTxData = ChainTxData{
                1737647486, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1737647491, 6, 0x207fffff, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x3708f8f50c5c890d8990bafba7acd413173449a3b616d6e38cb49a12ca2025a6"));
        assert(genesis.hashMerkleRoot == uint256S("0xe2a6a40237e19e792dbdd804e358f5efcde6482b9a24eb9bca738426812f6f0e"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x3708f8f50c5c890d8990bafba7acd413173449a3b616d6e38cb49a12ca2025a6")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 68Sv47gZtsFnYPFNYJ8MxWhurUa5SGU6js13z1TiERh6wMZnnTZ
        vSporkAddresses = {"B99W25d34J655ERZQ53y2bTp33PShwXXbn"};
        nMinSporkKeys = 1;
        ...
        // Regtest BitCUP addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        // Regtest BitCUP script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,26);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,153);
        // Regtest BitCUP BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest BitCUP BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest BitCUP BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
