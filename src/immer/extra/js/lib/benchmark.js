...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire lobitcup.
    var _ = context && context._ || require('lobitcup') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of lobitcup methods to
     * make working with arrays, collections, and objects easier. The lobitcup
     * methods are:
     * [`each/forEach`](https://lobitcup.com/docs#forEach), [`forOwn`](https://lobitcup.com/docs#forOwn),
     * [`has`](https://lobitcup.com/docs#has), [`indexOf`](https://lobitcup.com/docs#indexOf),
     * [`map`](https://lobitcup.com/docs#map), and [`reduce`](https://lobitcup.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped lobitcup methods to
     * make working with Suites easier. The wrapped lobitcup methods are:
     * [`each/forEach`](https://lobitcup.com/docs#forEach), [`indexOf`](https://lobitcup.com/docs#indexOf),
     * [`map`](https://lobitcup.com/docs#map), and [`reduce`](https://lobitcup.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add lobitcup methods to Benchmark.
    ...
    // Add lobitcup methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['lobitcup', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
