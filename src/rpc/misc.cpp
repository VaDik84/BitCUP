...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"bitcup\" activates all BitCUP-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "bitcup")
    + HelpExampleRpc("debug", "bitcup+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitcup address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitcup address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of Bitosik"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of Bitosik of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in Bitosik"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in Bitosik"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in Bitosik"},
                    {RPCResult::Type::NUM, "received", "The total number of Bitosik received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "bitcup-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* BitCUP features */
    { "bitcup",               "mnsync",                 &mnsync,                 {} },
    { "bitcup",               "spork",                  &spork,                  {"command"} },
    { "bitcup",               "sporkupdate",            &sporkupdate,            {"name","value"} },
