...
//! Interface for the src/evo part of a bitcup node (bitcupd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a bitcup node (bitcupd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a bitcup node (bitcupd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a bitcup node (bitcupd process).
...
//! Top-level interface for a bitcup node (bitcupd process).
class Node
{
public:
    virtual ~Node() {}
