/* depends/relic/include/relic_conf.h.  Generated from relic_conf.h.in by configure.  */
/* depends/relic/include/relic_conf.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define if C-only backend is requested. */
#define ARITH GMP
...
/* Define this symbol if big-endian support is enabled */
/* #undef BIGED */
...
/* Define this symbol if error-checking support is enabled */
/* #undef CHECK */

/* Define this symbol if colored output is enabled */
#define COLOR 1
...
/* Define this symbol if debugging support is enabled */
/* #undef DEBUG */
...
/* Backend based on GNU Multiple Precision library. */
#define GMP 2

/* Backend based on GNU Multiple Precision library, but using constant-time
   code. */
#define GMP_SEC 3
...
/* Define this symbol if overhead estimation is enabled */
/* #undef OVERH */
...
/* Define this symbol if profiling support is enabled */
/* #undef PROFL */
...
/* Define this symbol if printing is disabled */
#define QUIET 1
...
/* Unknown or unrecognized parameter. */
#define RELIC_NONE 0
...
/* Define this symbol if detailed error messages are enabled */
/* #undef VERBS */
