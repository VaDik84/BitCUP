...
official/supported Docker Images found at https://hub.docker.com/r/bitcuppay/bitcupd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/bitcuppay/bitcupd-develop/ when changing the above text**