...
Arguments:
    <base_directory> - The base directory of a BitCUP Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitCUP Core developers'
...
Arguments:
    <base_directory> - The base directory of BitCUP Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BitCUP Core repository.
"""
